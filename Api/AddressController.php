...
class AddressController extends Controller
{
    ...
    public function show_address(Request $request)
    {
        ...
        $addresss = DB::table('address')
            ...
            ->groupBy('type', 'address_id', 'lat', 'lng',  'user_id',
                'city', 'society', 'house_no', 'landmark',  'select_status', 'added_at', 'address_id', 'updated_at', 'city_id', 'society_id')
