...
class WishlistController extends Controller
{
    ...
    public function show_wishlist(Request $request)
    {
        ...
        $price1 = DB::table('wishlist')
            ...
            ->join('product_varient', 'store_products.varient_id', '=', 'product_varient.varient_id')
            ->join('product', 'product_varient.product_id', '=', 'product.product_id')
            ->select('store_products.price', 'product.isSpecial',)
        ...
        if ($wishlist_items != NULL) {
            ...
            $array = class2Array($wishlist_items);
            ...
            // AKTİF DİLDE VERİYİ GETİRMEK
            $message = array('status' => '1', 'message' => 'Wishlist items', 'count' => $count, 'data' => $class);
            return $message;
        } else {
